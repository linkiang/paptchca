 ...
 * 验证码生成类
 * 
 * 本类的简要描述： 使用开源验证码项目patchca生成 jar包：patchca-0.5.0.jar
...
public class VerifyCodeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * switch (r.nextInt(5)) { case 0: ccs.setFilterFactory(drff); break;
		 * case 1: ccs.setFilterFactory(mrff); break; case 2:
		 * ccs.setFilterFactory(drff); break; case 3:
		 * ccs.setFilterFactory(wrff); break; case 4:
		 * ccs.setFilterFactory(dirff); break; }
		 */
